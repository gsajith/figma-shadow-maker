...
export class BezierCurveEditor extends React.Component<IProps, IState> {
    ...
    private get height() {
        const { height } = this.props as PropsWithDefaults;
        return height;
    }
                ...
                <div className={styles.wrap}>
                    ...
                    <svg className={styles.curve} fill="none" width={svgWidth} height={svgHeight} viewBox={`0 0 ${svgWidth} ${svgHeight}`}>
                        <g transform={`translate(${strokeWidth}, ${outerAreaSize + strokeWidth})`}>
                            <line stroke={handleLineColor || styles.colorHandleLine} strokeWidth="1.5" strokeLinecap="round" x1={this.startCoordinate[0]} y1={this.startCoordinate[1]} x2={this.startBezierHandle[0]} y2={this.startBezierHandle[1]} />
                            <line stroke={handleLineColor || styles.colorHandleLine} strokeWidth="1.5" strokeLinecap="round" x1={this.endCoordinate[0]} y1={this.endCoordinate[1]} x2={this.endBezierHandle[0]} y2={this.endBezierHandle[1]} />
